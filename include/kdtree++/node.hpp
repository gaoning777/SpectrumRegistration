...
{
   /*
      _Node_base is a base struct for each node in KD-Tree from which _Node will inherit
      It only contains pointers information
Members: parent, left, right
Functions: findmin, findmax
    */
   struct _Node_base
   {
   ...
   /*
      _Node inherits _Node_base but has value in it.
Template: value type
Members: value
Functions: findmin, findmax
    */
...
Template: value type, dimension access function type, compare function type 
    */
